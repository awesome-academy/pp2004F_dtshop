                        ...
                        <ul class="list-media">
                            <li class="list-item unread-msg">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-1.jpg')}}"
                                            alt="">
                            ...
                            <li class="list-item unread-msg">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-2.jpg')}}"
                                            alt="">
                                        <span class="status success"></span>
                                    </div>
                                    <div class="info">
                            ...
                            <li class="list-item">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-3.jpg')}}"
                                            alt="">
                                        <span class="status success"></span>
                                    </div>
                                    <div class="info">
                    ...
                    <div class="m-b-30">
                        ...
                        <ul class="list-media">
                            <li class="list-item">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-4.jpg')}}"
                                            alt="">
                            ...
                            <li class="list-item">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-5.jpg')}}"
                                            alt="">
                                        <span class="status away"></span>
                                    </div>
                                    <div class="info">
                            ...
                            <li class="list-item">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-6.jpg')}}"
                                            alt="">
                                        <span class="status away"></span>
                                    </div>
                                    <div class="info">
                            ...
                            <li class="list-item">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-7.jpg')}}"
                                            alt="">
                                        <span class="status away"></span>
                                    </div>
                                    <div class="info">
                    ...
                    <div class="m-b-30">
                        ...
                        <ul class="list-media">
                            <li class="list-item">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-8.jpg')}}"
                                            alt="">
                            ...
                            <li class="list-item">
                                <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                    <div class="media-img">
                                        <img src="{{asset('applicator/dist/assets/images/avatars/thumb-9.jpg')}}"
                                            alt="">
                                        <span class="status busy"></span>
                                    </div>
                                    <div class="info">
                    ...
                    <div class="conversation-wrapper">
                        ...
                        <div class="quick-view-conversation-body conversation-body scrollable">
                            ...
                            <div class="msg msg-recipient">
                                <div class="user-img">
                                    <img src="{{asset('applicator/dist/assets/images/avatars/thumb-2.jpg')}}" alt="">
                                </div>
                                <div class="bubble">
                ...
                <ul class="list-media m-t-20">
                    <li class="list-item border bottom">
                        <a href="javascript:void(0);" class="media-hover p-20">
                            <div class="media-img">
                                <img src="{{asset('applicator/dist/assets/images/avatars/thumb-1.jpg')}}" alt="">
                            </div>
                            <div class="info">
                                <span class="title">Marshall Nichols</span>
                    ...
                    <li class="list-item border bottom">
                        <a href="javascript:void(0);" class="media-hover p-20">
                            <div class="media-img">
                                <img src="{{asset('applicator/dist/assets/images/avatars/thumb-8.jpg')}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <li class="list-item border bottom">
                        <a href="javascript:void(0);" class="media-hover p-20">
                            <div class="media-img">
                                <img src="{{asset('applicator/dist/assets/images/avatars/thumb-12.jpg')}}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <li class="list-item border bottom">
                        <a href="javascript:void(0);" class="media-hover p-20">
                            <div class="media-img">
                                <img src="{{asset('applicator/dist/assets/images/avatars/thumb-11.jpg')}}" alt="">
                            </div>
                            <div class="info">
