...
<html lang="en">
	<head>
		...
		<!-- bootstrap -->
		<link href="{{asset('shopper/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">      
		<link href="{{asset('shopper/bootstrap/css/bootstrap-responsive.min.css')}}" rel="stylesheet">
		
		<link href="{{asset('shopper/themes/css/bootstrappage.css')}}" rel="stylesheet"/>
		
		<!-- global styles -->
		<link href="{{asset('shopper/themes/css/flexslider.css')}}" rel="stylesheet"/>
		<link href="{{asset('shopper/themes/css/main.css')}}"rel="stylesheet"/>

		<!-- scripts -->
		<script src="{{asset('shopper/themes/js/jquery-1.7.2.min.js')}}"></script>
		<script src="{{asset('shopper/bootstrap/js/bootstrap.min.js')}}"></script>				
		<script src="{{asset('shopper/themes/js/superfish.js')}}"></script>	
		<script src="{{asset('shopper/themes/js/jquery.scrolltotop.js')}}"></script>
		<!--[if lt IE 9]>			
    ...
    <body>		
		...
		<script src="{{asset('shopper/themes/js/common.js')}}"></script>
		<script src="{{asset('shopper/themes/js/jquery.flexslider-min.js')}}"></script>
